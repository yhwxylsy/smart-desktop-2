...
> **历史留档（2026-09-06 追加）：** 本文是 2026-06-24 的快照，原文不再修改。
> 此后 STM32 串口接线做了改造：`PB10 / USART3_TX` 由 SYN6288 改接 ESP32S3 `D7/GPIO44`，
> 上行不再走 `PB3` 软件串口；`PB3` 改为驱动 SYN6288；两端波特率由 `9600/4800` 统一为 `115200`。
> 因此文中“STM32 PB3/software TX -> ESP32S3 ... 4800 8N1”“SYN6288 | PB10 USART3_TX”
> 以及“PB3 软件串口偶发脏前缀”等描述**已不代表当前状态**，
> 当前权威接线见 `docs/HARDWARE_WIRING.md`。
